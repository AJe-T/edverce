...
export default function Page() {
  return (
    <div className="animate-fade-in min-h-screen pt-28 pb-20 flex items-center justify-center px-6 relative z-10 w-full">
      <div className="absolute top-1/4 left-1/3 w-96 h-96 bg-blue-600/20 rounded-full transform-gpu filter blur-[120px] pointer-events-none" />
        ...
        <SignIn
          appearance={{
            ...
            elements: {
              ...
              formButtonPrimary:
                "w-full bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-xl transition-colors shadow-[0_0_20px_rgba(37,99,235,0.2)] hover:shadow-[0_0_30px_rgba(37,99,235,0.4)]",
